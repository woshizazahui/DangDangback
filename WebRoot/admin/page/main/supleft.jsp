   ...
   <kuaige:zkf resource="product"  >
    <li> <a class="head">商品管理</a>
      <ul>
        ...
        <li><a href="${pageContext.request.contextPath }/goods/queryBooks" target="rightFrame">商品列表</a></li>
      </ul>
    </li>
    </kuaige:zkf>
    <kuaige:zkf resource="category" >
     <li> <a class="head">商品类别管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath }/admin/page/main/addcategoryThis.jsp" target="rightFrame">增加商品类别</a></li>
        <li><a href="${pageContext.request.contextPath }/category/showCategorys?pageIndex=1" target="rightFrame">商品类别列表</a></li>
      </ul>
    </li>
    </kuaige:zkf>
    <kuaige:zkf resource="order" >
    <li> <a class="head">订单管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath }/order/selectAllOrder" target="rightFrame">订单列表</a></li>
      </ul>
    </li>
   </kuaige:zkf>
   <kuaige:zkf resource="sales" >
    <li> <a class="head">销量明细</a>
      <ul>
        <li><a href="${pageContext.request.contextPath}/echarts2.jsp" target="rightFrame">销量图例</a></li>
      </ul>
    </li>
   </kuaige:zkf>
